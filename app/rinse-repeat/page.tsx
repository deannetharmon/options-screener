...
1. Any near-term risks (earnings, macro, sector headwinds)
1. Analyst/market sentiment
1. Whether conditions currently favor selling premium (credit spreads) on this stock
...
<button
onClick={handleClick}
className={`inline-flex items-center gap-1 text-[9px] px-2 py-0.5 border rounded transition-colors ${ open ? 'border-indigo-500 text-indigo-400 bg-indigo-500/10' : `${th.border} ${th.textFaint} hover:border-indigo-500 hover:text-indigo-400` }`}>
